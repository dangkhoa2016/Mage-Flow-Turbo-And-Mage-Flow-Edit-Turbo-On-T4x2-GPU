...
`scripts/run_public_candidate.sh` starts or reuses healthy resident T2I/Edit workers. Live acceptance does not reload the models. The accepted candidate records resident-worker reuse and zero runtime re-extraction during the reuse path.
