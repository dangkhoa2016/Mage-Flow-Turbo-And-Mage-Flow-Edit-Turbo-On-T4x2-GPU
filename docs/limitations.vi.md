...
GPU acceptance chứng minh acceptance surface T4 x2 đã được kiểm thử; nó không phải bảo đảm cho phần cứng tùy ý, model revision khác hoặc dependency version trong tương lai.
